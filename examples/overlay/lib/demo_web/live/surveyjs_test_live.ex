defmodule DemoWeb.SurveyjsTestLive do
  ...
  def mount(_params, _session, socket) do
    ...
    form_path = Path.join(:code.priv_dir(:demo), "surveyjs_test_form.json")
    payment_form_path = Path.join(:code.priv_dir(:demo), "surveyjs_payment_form.json")
    ...
    <Layouts.app flash={@flash}>
      <div class="max-w-5xl mx-auto py-8 px-4">
        ...
        <.definition
          ...
          subtitle="Loaded from a SurveyJS-compatible JSON file and decoded with DynamicForm.Instance.decode!/1"
          code={Jason.encode!(active_instance(@active_form, @test_form, @payment_form), pretty: true)}
        />
