defmodule DemoWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="px-4 sm:px-6 lg:px-8">
      <div class="mx-auto flex max-w-5xl items-center justify-between border-b border-zinc-100 py-3 text-sm">
        <.link navigate="/" class="font-semibold text-zinc-900 hover:text-zinc-700">
          DynamicForm Demo
        </.link>
  ...
  Unused by the demo (the root layout pins the light theme, which the
  DynamicForm components are styled for), but kept because the generated
  home template references it.
  """
